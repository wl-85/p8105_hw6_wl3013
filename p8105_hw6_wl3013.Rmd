...
The 95% CI for R square is (`r round(boot_ci_r2[1], 4)`, `r round(boot_ci_r2[2], 4)`).
The 95% CI for ratio (β1/β2) is (`r round(boot_ci_ratio[1], 4)`, `r round(boot_ci_ratio[2], 4)`).
